...
class OnboardScreenSeeder extends Seeder
{
    ...
    public function run()
    {
        $app_onboard_screens = array(
            ...
            array('type'=>GlobalConst::AGENT,'title' => 'Get Profit in Every Transaction','sub_title' => 'Start your agency business with QRPay Pro and get the best profit on every transaction','image' => 'seeder/agent/onboard.png','status' => '1','last_edit_by' => '1','created_at' => now(),'updated_at' => now()),
