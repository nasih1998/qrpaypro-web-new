        ...
        <div class="table-responsive">
            <table class="custom-table">
                ...
                <tbody>
                    ...
                    @php
                        $precision = get_precision($item->currency->gateway);
                    @endphp
                        <tr>
                            <td>{{ $item->trx_id }}</td>
                            <td>
                            ...
                            <td>{{ get_amount($item->request_amount,withdrawCurrency($item)['wallet_currency'],get_wallet_precision($item->creator_wallet->currency)) }}</td>
