                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_default_currency_symbol() }}{{ get_amount($data['add_money_total_balance'],null,get_wallet_precision()) }}</h2>
                                </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_default_currency_symbol() }}{{ get_amount($data['total_money_out'],null,get_wallet_precision()) }}</h2>
                                </div>
                                <div class="user-badge">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_default_currency_symbol() }}{{ get_amount($data['total_profits'],null,get_wallet_precision()) }}</h2>
                                </div>
                                <div class="user-badge">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_default_currency_symbol() }}{{ get_amount($data['total_remittance'],null,get_wallet_precision()) }}</h2>
                                </div>
                                <div class="user-badge">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{  get_default_currency_symbol() }} {{ get_amount(flutterwaveBalance()['balance'],null,get_wallet_precision()) }}</h2>
                                </div>
                            </div>
                            ...
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_default_currency_symbol() }}{{ get_amount(getIssueBalance()['amount'],null,get_wallet_precision()) }}</h2>
                                </div>
                            </div>
                            ...
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{  get_default_currency_symbol() }} {{get_amount(getSudoBalance()['amount'],null,get_wallet_precision()) }}</h2>
                                </div>
                            </div>
                            ...
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{  get_default_currency_symbol() }} {{get_amount(strowalletBalance()['balance'],null,get_wallet_precision()) }}</h2>
                                </div>
                            </div>
                            @endif
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{  get_default_currency_symbol() }}{{get_amount(totalAdminProfits(),get_default_currency_code(),get_wallet_precision()) }}</h2>
                                </div>
                            </div>
