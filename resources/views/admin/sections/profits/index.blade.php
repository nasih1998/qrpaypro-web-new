                ...
                <tbody>
                    ...
                    @endphp
                        ...
                        <tr>
                            ...
                            <td>{{ get_amount($total_charge ,$item->transactions->creator_wallet->currency->code??get_default_currency_code(),get_wallet_precision($item->transactions->creator_wallet->currency)) }}</td>
