                    ...
                    <tbody>
                        @forelse ($transactions  as $key => $item)
                            <tr>
                                ...
                                <td>{{ get_amount(@$item->request_amount, @$item->details->charge_calculation->receiver_currency_code,get_wallet_precision($item->creator_wallet->currency)) }}</td>
                                <td>{{ get_amount(@$item->payable, @$item->details->charge_calculation->receiver_currency_code,get_wallet_precision($item->creator_wallet->currency)) }}</td>
