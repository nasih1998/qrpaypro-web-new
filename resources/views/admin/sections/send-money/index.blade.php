                    ...
                    @forelse ($transactions ?? []  as $key => $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ setRoute('admin.users.details',$item->details->receiver->username?? $item->details->receiver_username) }}">{{ $item->details->receiver->email?? $item->details->receiver_email }}</a>
                                @elseif($item->agent_id != null)
                                <a href="{{ setRoute('admin.agents.details',$item->details->receiver->username??$item->details->receiver_username) }}">{{ $item->details->receiver->email??$item->details->receiver_email }}</a>
                                @endif
                            </td>
                            ...
                            <td>{{ get_amount($item->details->charges->payable??$item->payable,$item->details->charges->sender_currency??$item->payable,get_wallet_precision($item->creator_wallet->currency)) }}</td>
                            <td>
