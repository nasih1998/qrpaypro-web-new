                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <h3 class="title">{{ get_amount($data['totalAddMoney'],null,get_wallet_precision()) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                        </div>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <h3 class="title">{{ get_amount($data['totalWithdrawMoney'],null,get_wallet_precision()) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                        </div>
                        <div class="dashboard-icon">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <h3 class="title">{{ get_amount($data['totalSendMoney'],null,get_wallet_precision()) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                        </div>
                        <div class="dashboard-icon">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <h3 class="title">{{ get_amount($data['totalMoneyIn'],null,get_wallet_precision()) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                        </div>
                        <div class="dashboard-icon">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <h3 class="title">{{ get_amount($data['totalReceiveMoney'],null,get_wallet_precision()) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                        </div>
                        <div class="dashboard-icon">
                    ...
                    <a href="{{ setRoute('agent.profits.index') }}" class="d-block">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                ...
                                <h3 class="title">{{ get_amount($data['agent_profits'],null,get_wallet_precision()) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                            </div>
                            <div class="dashboard-icon">
