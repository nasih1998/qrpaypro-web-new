                ...
                <table class="custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ get_amount(1,$item->card_currency) ." = ". get_amount($item->exchange_rate,$item->user_wallet_currency,get_wallet_precision($item->userWallet->currency))}}</td>
                            <td>{{ get_amount($item->unit_amount,$item->user_wallet_currency,get_wallet_precision($item->userWallet->currency))}}</td>
                            <td>{{ get_amount($item->total_charge,$item->user_wallet_currency,get_wallet_precision($item->userWallet->currency))}}</td>
                            <td>{{ get_amount($item->total_payable,$item->user_wallet_currency,get_wallet_precision($item->userWallet->currency))}}</td>
