    ...
    */
    ...
    public function sendVerifyCode(Request $request){
        ...
        if($validated['register_type'] == GlobalConst::PHONE){
            ...
            Session::flash('success', [__('SMS Verification Code Send.')]);
            return Response::success(['success' => [__('SMS Verification Code Send.')]],['url' => route('agent.sms.verify',$data['token'])]);
        }else{
