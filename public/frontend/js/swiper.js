                ...
                (e.onTouchEnd = function (e) {
                    ...
                    if (((a.isTouched = !1), (a.isMoved = !1), (a.startMoving = !1), (p = i.followFinger ? (r ? t.translate : -t.translate) : -a.currentTranslate), i.freeMode)) {
                        ...
                        if (i.freeModeMomentum) {
                            ...
                            if (w < t.maxTranslate())
                                i.freeModeMomentumBounce ? (w + t.maxTranslate() < -T && (w = t.maxTranslate() - T), (y = t.maxTranslate()), (E = !0), (a.allowMomentumBounce = !0)) : (w = t.maxTranslate()),
                                    i.loop && i.centeredSlides && (x = !0);
                            else if (w > t.minTranslate())
                                i.freeModeMomentumBounce ? (w - t.minTranslate() > T && (w = t.minTranslate() + T), (y = t.minTranslate()), (E = !0), (a.allowMomentumBounce = !0)) : (w = t.minTranslate()),
                                    i.loop && i.centeredSlides && (x = !0);
            ...
            enableDraggable: function () {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    Y.touch || (!Y.pointerEvents && !Y.prefixedPointerEvents)
                        ? (Y.touch && (r.addEventListener(a.start, e.scrollbar.onDragStart, n), r.addEventListener(a.move, e.scrollbar.onDragMove, n), r.addEventListener(a.end, e.scrollbar.onDragEnd, o)),
            ...
            disableDraggable: function () {
                ...
                if (e.params.scrollbar.el) {
                    var t = e.scrollbar,
                        ...
                        o = !(!Y.passiveListener || !s.passiveListeners) && { passive: !0, capture: !1 };
                    Y.touch || (!Y.pointerEvents && !Y.prefixedPointerEvents)
                        ? (Y.touch && (r.removeEventListener(a.start, e.scrollbar.onDragStart, n), r.removeEventListener(a.move, e.scrollbar.onDragMove, n), r.removeEventListener(a.end, e.scrollbar.onDragEnd, o)),
                          ((s.simulateTouch && !m.ios && !m.android) || (s.simulateTouch && !Y.touch && m.ios)) &&
